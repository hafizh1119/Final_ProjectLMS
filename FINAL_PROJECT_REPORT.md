...
Final Project Learning Management System (LMS) berhasil dikembangkan dengan mengimplementasikan seluruh fitur dasar, yaitu autentikasi menggunakan JWT, manajemen course, lesson, enrollment, progress belajar, serta Role-Based Access Control (RBAC) untuk Admin, Instructor, dan Student. Selain itu, beberapa fitur tambahan juga berhasil diimplementasikan, meliputi pencarian, filter, dan sorting course, rating dan review, wishlist, curriculum berbasis module dan lesson, serta student dashboard yang menampilkan course aktif, progress belajar, dan rekomendasi course. Seluruh fitur telah diuji dan dapat berjalan sesuai dengan kebutuhan project.

Melalui pengerjaan project ini, penulis memperoleh pengalaman dalam mengembangkan REST API menggunakan Django Ninja, mengelola autentikasi dan otorisasi pengguna, merancang struktur database yang lebih terorganisir, serta menerapkan Docker Compose untuk proses deployment dan pengujian. Selain itu, penulis juga memperoleh pengalaman dalam menyelesaikan berbagai kendala teknis selama proses pengembangan, seperti implementasi RBAC, penyusunan curriculum, serta pengelolaan repository menggunakan Git. Pengalaman tersebut memberikan pemahaman yang lebih baik mengenai proses pengembangan aplikasi backend secara terstruktur dan kolaboratif.
